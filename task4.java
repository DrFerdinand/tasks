...
class Task4 {
    ...
    public static void main(String[] args) {
        assert Bessy(10, 7, "hello my name is Bessie and this is my essay")
            .equals(
                "hello my\n" +
                "name is\n" +
                "Bessie\n" +
        ...
        assert Arrays.equals(split("()()()"), new String[] {"()", "()", "()"});
        assert Arrays.equals(split("((()))"), new String[] {"((()))"});
        assert Arrays.equals(split("((()))(())()()(()())"), new String[] {"((()))", "(())", "()", "()", "(()())"});
        assert Arrays.equals(split("((())())(()(()()))"), new String[] {"((())())", "(()(()()))"});
        
        assert toCamelCase("hello_edabit").equals("helloEdabit");
        assert toSnakeCase("helloEdabit").equals("hello_edabit");
        assert toCamelCase("is_modal_open").equals("isModalOpen");
        assert toSnakeCase("getColor").equals("get_color");
        
        assert overTime(new double[] {9, 17, 30, 1.5}).equals("$240.0");
        assert overTime(new double[] {16, 18, 30, 1.8}).equals("$84.0");
        assert overTime(new double[] {13.25, 15, 30, 1.5}).equals("$52.5");
        
        assert BMI("205 pounds", "73 inches").equals("27.0 Overweight");
        assert BMI("55 kilos", "1.65 meters").equals("20.2 Normal weight");
        assert BMI("154 pounds", "2 meters").equals("17.5 Underweight");
        
        assert bugger(39) == 3;
        assert bugger(999) == 4;
        assert bugger(4) == 0;
        
        assert toStarShorthand("abbccc").equals("ab*2c*3");
        assert toStarShorthand("77777geff").equals("7*5gef*2");
        assert toStarShorthand("abc").equals("abc");
        assert toStarShorthand("").equals("");
        ...
        assert trouble(451999277, 41177722899L) == true;
        assert trouble(1222345, 12345) == false;
        assert trouble(666789, 12345667) == true;
        assert trouble(33789, 12345337) == false;
        
        assert countUniqueBooks("AZYWABBCATTTA", 'A') == 4;
        assert countUniqueBooks("$AA$BBCATT$C$$B$", '$') == 3;
        assert countUniqueBooks("ZZABCDEF", 'Z') == 0;
    }
}